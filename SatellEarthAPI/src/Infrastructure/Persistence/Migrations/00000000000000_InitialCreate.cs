...
namespace SatellEarthAPI.Infrastructure.Persistence.Migrations;
...
public partial class InitialCreate : Migration
{
    ...
    protected void MigrateSQLDb(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Legend = table.Column<string>(type: "nvarchar(50)", nullable: false),
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_Aleas", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                PremierReleve = table.Column<DateTime>(type: "datetime2", nullable: false),
                DernierReleve = table.Column<DateTime>(type: "datetime2", nullable: false),
                NbRessenti = table.Column<int>(type: "int", nullable: false),
                LienSource = table.Column<string>(type: "nvarchar(150)", nullable: true),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Disasters_Aleas_AleaId",
                    column: x => x.AleaId,
                    principalTable: "Aleas",
                    principalColumn: "Id",
    ...
    protected void MigratePgSQLDb(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastModifiedBy = table.Column<string>(type: "VARCHAR", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_Disasters", x => x.Id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Data = table.Column<string>(type: "VARCHAR", maxLength: 50000, nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_DeviceCodes", x => x.UserCode);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Version = table.Column<int>(type: "int", nullable: false),
                Created = table.Column<DateTime>(type: "timestamp", nullable: false),
                Use = table.Column<string>(type: "VARCHAR(450)", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Priority = table.Column<int>(type: "int", nullable: false),
                Reminder = table.Column<DateTime>(type: "timestamp", nullable: true),
